...
export default defineConfig({
  ...
  srcExclude: [
    '**/00_START_HERE.md',
    '**/ARMBIAN-DEPLOYMENT.md',
    '**/ARMBIAN_DEPLOYMENT.vi.md',
    '**/CODE_OF_CONDUCT.md',
    '**/DEPLOYMENT.md',
